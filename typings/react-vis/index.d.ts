declare module "react-vis" {
  ...
  export type RVItemsFormat = (values: any[]) => { value: any; title: any };
  ...
  export const ScaleUtils: {
    extractScalePropsFromProps: (props: AbstractSeriesProps<AbstractSeriesPoint>, attributes: string[]) => { [key: string]: any };
    ...
    getMissingScaleProps: (props: AbstractSeriesProps<AbstractSeriesPoint>, data: any[], attributes: string[]) => { [key: string]: any };
    ...
    getXYPlotValues: (props: AbstractSeriesProps<AbstractSeriesPoint>, children: ReactChild[]) => { [key: string]: any };
